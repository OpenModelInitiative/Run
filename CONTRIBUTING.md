...
1. Check whether the change you want to introduce is not already present in the base repository.
   Main base repository can be cloned from: https://github.com/OpenModelInitiative/Run
2. Check whether the change you want to introduce has not been already submitted by someone else.
    - https://github.com/OpenModelInitiative/Run/pulls
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) our Run base repository.
2. Clone your copy of base `git clone git@github.com:OpenModelInitiative/Run.git`.
